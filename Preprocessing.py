...
#path1 is the address to the folder of all subjects, each subject has three txt files for alert, semisleepy and sleepy levels
path1='DeepLearning-DrowsinessDetection/Dataset'
test = "Full"
window_size=30
stride=2
...
Training='DeepLearning-DrowsinessDetection/npy/Blinks_Full.npy'
Train_Labels ='DeepLearning-DrowsinessDetection/npy/Labels_Full.npy'
Testing='DeepLearning-DrowsinessDetection/npy/BlinksTest_Full.npy'
Test_Labels ='DeepLearning-DrowsinessDetection/npy/LabelsTest_Full.npy'
